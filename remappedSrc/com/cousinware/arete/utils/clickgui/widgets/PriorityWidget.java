...
public class PriorityWidget extends Widget {
    ...
    public PriorityWidget(ModuleWidget moduleWidget, IntSetting setting, int yOffset) {
        timer = new Timer(5);
    ...
    public void render(DrawContext drawContext) {
        ...
        if (dragging) {
            ...
            if (setting instanceof IntSetting) {
                AreteClient.moduleManager.priorityUpdated = true;
                setting.setValue((int)value);
                moduleWidget.module.priority = (int)value;
